...
static const uint8_t ITEM_ATTR_TAGS[16][4] = {
    /* 0x0001 */ { 0x95, 0xbe, 0x8a, 0xed },  /* 武器  weapon                 */
    /* 0x0002 */ { 0x96, 0x68, 0x8b, 0xef },  /* 防具  armour                 */
    /* 0x0004 */ { 0x83, 0x41, 0x83, 0x4e },  /* アク  accessory (アクセサリ)  */
    /* 0x0008 */ { 0x90, 0x48, 0x95, 0x69 },  /* 食品  food (also tag 0x2000) */
    /* 0x0010 */ { 0x95, 0x90, 0x8a, 0xed },  /* 武器  weapon variant         */
