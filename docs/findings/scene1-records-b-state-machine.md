...
| C8jb.5b | Phase B general damage formula: base damage (DAT_056db0b4 idle / per-NPC-type +0x3c curve) × per-NPC-type +0x34 KB modifier × FUN_0041f46d RNG scale + 4× FUN_0043647f combo modifiers + scene-state mul DAT_056db014/01c + slot[7..0xc] knockback-state mods + LAB_00438e6d *2 chain. | L35308-L35385 | ~150 | damage int computed |
| C8jb.5c | Phase B post-damage clamps: NPC 0x12 + 0x44/0x45 + sub-iter==0 + phase!=6 reset + charge bit (slot[0x25] atan2-into-facing) + npc_phase 1-6 → local_1c bit 8 + atan2 quadrant bits + slot[1]==0 OWNER_A flag mods + LAB_004390d3 (local_18-armed) clamp + type-5 < 0 clamp + general < 1/<5 RNG clamp. | L35386-L35430 | ~120 | full damage clamp/quadrant flags |
