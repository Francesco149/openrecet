...
```
███░░░░░░░░░░░░░░░░░  14.6% touched   (2.4% runtime-verified)
```
...
| ported    |   296 | reimplemented in src/, no runtime probe yet              |
| **touched** | **372** | verified + stubbed + ported                         |
| unported  |  2176 | exists in engine, never referenced from src/             |
