...
```
████░░░░░░░░░░░░░░░░  19.9% touched   (2.7% runtime-verified)
```
...
| ported    |   422 | reimplemented in src/, no runtime probe yet              |
| **touched** | **506** | verified + stubbed + ported                         |
| unported  |  2042 | exists in engine, never referenced from src/             |
