...
```
███░░░░░░░░░░░░░░░░░  16.8% touched   (2.8% runtime-verified)
```
...
| ported    |   341 | reimplemented in src/, no runtime probe yet              |
| **touched** | **427** | verified + stubbed + ported                         |
| unported  |  2121 | exists in engine, never referenced from src/             |
