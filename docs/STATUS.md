...
```
███░░░░░░░░░░░░░░░░░  17.4% touched   (2.7% runtime-verified)
```
...
| ported    |   360 | reimplemented in src/, no runtime probe yet              |
| **touched** | **444** | verified + stubbed + ported                         |
| unported  |  2104 | exists in engine, never referenced from src/             |
