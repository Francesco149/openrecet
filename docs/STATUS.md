...
```
███░░░░░░░░░░░░░░░░░  16.0% touched   (2.6% runtime-verified)
```
...
| ported    |   324 | reimplemented in src/, no runtime probe yet              |
| **touched** | **408** | verified + stubbed + ported                         |
| unported  |  2140 | exists in engine, never referenced from src/             |
