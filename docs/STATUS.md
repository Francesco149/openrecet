...
```
███░░░░░░░░░░░░░░░░░  16.9% touched   (2.7% runtime-verified)
```
...
| ported    |   347 | reimplemented in src/, no runtime probe yet              |
| **touched** | **431** | verified + stubbed + ported                         |
| unported  |  2117 | exists in engine, never referenced from src/             |
