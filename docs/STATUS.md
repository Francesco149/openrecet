...
```
███░░░░░░░░░░░░░░░░░  16.4% touched   (2.8% runtime-verified)
```
...
| ported    |   329 | reimplemented in src/, no runtime probe yet              |
| **touched** | **418** | verified + stubbed + ported                         |
| unported  |  2130 | exists in engine, never referenced from src/             |
