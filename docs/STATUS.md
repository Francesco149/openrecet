...
```
████░░░░░░░░░░░░░░░░  20.2% touched   (2.7% runtime-verified)
```
...
| ported    |   430 | reimplemented in src/, no runtime probe yet              |
| **touched** | **514** | verified + stubbed + ported                         |
| unported  |  2034 | exists in engine, never referenced from src/             |
