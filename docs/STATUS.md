...
```
████░░░░░░░░░░░░░░░░  22.0% touched   (2.7% runtime-verified)
```
...
| ported    |   477 | reimplemented in src/, no runtime probe yet              |
| **touched** | **561** | verified + stubbed + ported                         |
| unported  |  1987 | exists in engine, never referenced from src/             |
