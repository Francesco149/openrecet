...
```
████░░░░░░░░░░░░░░░░  21.7% touched   (2.7% runtime-verified)
```
...
| ported    |   468 | reimplemented in src/, no runtime probe yet              |
| **touched** | **552** | verified + stubbed + ported                         |
| unported  |  1996 | exists in engine, never referenced from src/             |
