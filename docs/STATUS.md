...
```
████░░░░░░░░░░░░░░░░  18.8% touched   (2.7% runtime-verified)
```
...
| ported    |   395 | reimplemented in src/, no runtime probe yet              |
| **touched** | **479** | verified + stubbed + ported                         |
| unported  |  2069 | exists in engine, never referenced from src/             |
...
**Port debt:** 23 `PORT-DEBT(...)` markers — MVP/synthetic shortcuts
