...
```
████░░░░░░░░░░░░░░░░  20.3% touched   (2.7% runtime-verified)
```
...
| ported    |   434 | reimplemented in src/, no runtime probe yet              |
| **touched** | **518** | verified + stubbed + ported                         |
| unported  |  2030 | exists in engine, never referenced from src/             |
