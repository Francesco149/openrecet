...
```
████░░░░░░░░░░░░░░░░  20.4% touched   (2.7% runtime-verified)
```
...
| ported    |   437 | reimplemented in src/, no runtime probe yet              |
| **touched** | **521** | verified + stubbed + ported                         |
| unported  |  2027 | exists in engine, never referenced from src/             |
