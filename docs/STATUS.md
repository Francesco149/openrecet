...
```
████░░░░░░░░░░░░░░░░  19.1% touched   (2.7% runtime-verified)
```
...
| ported    |   402 | reimplemented in src/, no runtime probe yet              |
| **touched** | **486** | verified + stubbed + ported                         |
| unported  |  2062 | exists in engine, never referenced from src/             |
