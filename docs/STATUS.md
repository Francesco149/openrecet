...
```
███░░░░░░░░░░░░░░░░░  15.6% touched   (2.6% runtime-verified)
```
...
| ported    |   314 | reimplemented in src/, no runtime probe yet              |
| **touched** | **398** | verified + stubbed + ported                         |
| unported  |  2150 | exists in engine, never referenced from src/             |
