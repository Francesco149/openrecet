...
```
████░░░░░░░░░░░░░░░░  21.0% touched   (2.7% runtime-verified)
```
...
| ported    |   452 | reimplemented in src/, no runtime probe yet              |
| **touched** | **536** | verified + stubbed + ported                         |
| unported  |  2012 | exists in engine, never referenced from src/             |
