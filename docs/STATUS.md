...
```
████░░░░░░░░░░░░░░░░  21.5% touched   (2.7% runtime-verified)
```
...
| ported    |   465 | reimplemented in src/, no runtime probe yet              |
| **touched** | **549** | verified + stubbed + ported                         |
| unported  |  1999 | exists in engine, never referenced from src/             |
