...
```
███░░░░░░░░░░░░░░░░░  14.4% touched   (2.4% runtime-verified)
```
...
| ported    |   293 | reimplemented in src/, no runtime probe yet              |
| **touched** | **368** | verified + stubbed + ported                         |
| unported  |  2180 | exists in engine, never referenced from src/             |
