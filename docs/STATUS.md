...
```
███░░░░░░░░░░░░░░░░░  17.0% touched   (2.7% runtime-verified)
```
...
| ported    |   348 | reimplemented in src/, no runtime probe yet              |
| **touched** | **432** | verified + stubbed + ported                         |
| unported  |  2116 | exists in engine, never referenced from src/             |
