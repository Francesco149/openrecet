...
```
████░░░░░░░░░░░░░░░░  18.7% touched   (2.7% runtime-verified)
```
...
| ported    |   392 | reimplemented in src/, no runtime probe yet              |
| **touched** | **476** | verified + stubbed + ported                         |
| unported  |  2072 | exists in engine, never referenced from src/             |
