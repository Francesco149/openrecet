...
```
█████░░░░░░░░░░░░░░░  22.6% touched   (2.8% runtime-verified)
```
...
| ported    |   490 | reimplemented in src/, no runtime probe yet              |
| **touched** | **575** | verified + stubbed + ported                         |
| unported  |  1973 | exists in engine, never referenced from src/             |
