...
```
███░░░░░░░░░░░░░░░░░  15.4% touched   (2.6% runtime-verified)
```
...
| ported    |   309 | reimplemented in src/, no runtime probe yet              |
| **touched** | **393** | verified + stubbed + ported                         |
| unported  |  2155 | exists in engine, never referenced from src/             |
