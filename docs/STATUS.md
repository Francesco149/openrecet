...
```
████░░░░░░░░░░░░░░░░  20.8% touched   (2.7% runtime-verified)
```
...
| ported    |   446 | reimplemented in src/, no runtime probe yet              |
| **touched** | **530** | verified + stubbed + ported                         |
| unported  |  2018 | exists in engine, never referenced from src/             |
