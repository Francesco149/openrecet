...
```
███░░░░░░░░░░░░░░░░░  14.0% touched   (2.3% runtime-verified)
```

| status    | count | what it means                                            |
|-----------|------:|----------------------------------------------------------|
| verified  |    58 | CALL_TRACE_ENTER probe, runtime-diffed vs retail         |
| stubbed   |    12 | CALL_TRACE_ENTER_STUB — wired but body incomplete        |
| ported    |   287 | reimplemented in src/, no runtime probe yet              |
| **touched** | **357** | verified + stubbed + ported                         |
| unported  |  2191 | exists in engine, never referenced from src/             |
