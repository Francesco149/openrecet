...
```
███░░░░░░░░░░░░░░░░░  14.4% touched   (2.3% runtime-verified)
```
...
| ported    |   294 | reimplemented in src/, no runtime probe yet              |
| **touched** | **367** | verified + stubbed + ported                         |
| unported  |  2181 | exists in engine, never referenced from src/             |
