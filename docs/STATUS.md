...
```
████░░░░░░░░░░░░░░░░  18.9% touched   (2.7% runtime-verified)
```
...
| ported    |   397 | reimplemented in src/, no runtime probe yet              |
| **touched** | **481** | verified + stubbed + ported                         |
| unported  |  2067 | exists in engine, never referenced from src/             |
