...
```
███░░░░░░░░░░░░░░░░░  16.5% touched   (2.9% runtime-verified)
```
...
| ported    |   330 | reimplemented in src/, no runtime probe yet              |
| **touched** | **420** | verified + stubbed + ported                         |
| unported  |  2128 | exists in engine, never referenced from src/             |
