...
```
████░░░░░░░░░░░░░░░░  22.4% touched   (2.8% runtime-verified)
```
...
| ported    |   486 | reimplemented in src/, no runtime probe yet              |
| **touched** | **571** | verified + stubbed + ported                         |
| unported  |  1977 | exists in engine, never referenced from src/             |
