...
```
███░░░░░░░░░░░░░░░░░  14.1% touched   (2.3% runtime-verified)
```
...
| ported    |   288 | reimplemented in src/, no runtime probe yet              |
| **touched** | **358** | verified + stubbed + ported                         |
| unported  |  2190 | exists in engine, never referenced from src/             |
