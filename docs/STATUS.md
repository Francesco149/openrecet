...
```
███░░░░░░░░░░░░░░░░░  16.8% touched   (2.7% runtime-verified)
```
...
| ported    |   344 | reimplemented in src/, no runtime probe yet              |
| **touched** | **428** | verified + stubbed + ported                         |
| unported  |  2120 | exists in engine, never referenced from src/             |
