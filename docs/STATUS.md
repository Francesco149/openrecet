...
```
████░░░░░░░░░░░░░░░░  19.5% touched   (2.7% runtime-verified)
```
...
| ported    |   413 | reimplemented in src/, no runtime probe yet              |
| **touched** | **497** | verified + stubbed + ported                         |
| unported  |  2051 | exists in engine, never referenced from src/             |
