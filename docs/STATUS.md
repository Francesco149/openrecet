...
```
█████░░░░░░░░░░░░░░░  22.7% touched   (2.8% runtime-verified)
```
...
| ported    |   493 | reimplemented in src/, no runtime probe yet              |
| **touched** | **578** | verified + stubbed + ported                         |
| unported  |  1970 | exists in engine, never referenced from src/             |
