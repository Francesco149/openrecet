...
```
███░░░░░░░░░░░░░░░░░  15.5% touched   (2.6% runtime-verified)
```
...
| ported    |   310 | reimplemented in src/, no runtime probe yet              |
| **touched** | **394** | verified + stubbed + ported                         |
| unported  |  2154 | exists in engine, never referenced from src/             |
...
**Port debt:** 9 `PORT-DEBT(...)` markers — MVP/synthetic shortcuts
