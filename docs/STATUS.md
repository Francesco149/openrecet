...
```
████░░░░░░░░░░░░░░░░  21.6% touched   (2.7% runtime-verified)
```
...
| ported    |   466 | reimplemented in src/, no runtime probe yet              |
| **touched** | **550** | verified + stubbed + ported                         |
| unported  |  1998 | exists in engine, never referenced from src/             |
