...
```
████░░░░░░░░░░░░░░░░  20.9% touched   (2.7% runtime-verified)
```
...
| ported    |   448 | reimplemented in src/, no runtime probe yet              |
| **touched** | **532** | verified + stubbed + ported                         |
| unported  |  2016 | exists in engine, never referenced from src/             |
