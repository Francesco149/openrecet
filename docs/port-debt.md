...
| FUN_004536cb | src/sim.c:277 | retail freezes the *entire |
| FUN_00473c03 | src/scene1_intro_dialogue.c:157 | the engine teardown also restores the |

## hardcode (1)

| retire | location | what's synthetic |
|--------|----------|------------------|
| NONE | src/scene.c:48 | active save-slot pinned to bank 0; |
