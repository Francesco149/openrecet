...
| FUN_00453384 | src/scene_pause.c:224 | the engine has a thicket of mode-1 |
| FUN_004536cb | src/sim.c:296 | retail freezes the *entire |
...
| door-exit-reset | DAT_056db000 | src/scene1_player_ctrl.c:1058 | the engine also zeroes |
