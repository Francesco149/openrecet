# Historical plan: HOUSE free-roam render/depth structural parity

> **ARCHIVED 2026-07-16.** The open Phase-4/3D-mesh-occluder conclusion below was
> disproved on 2026-06-04. Retail uses records-A projection `z_far=500`; the port used
> 2000. Correcting it restored occlusion, and foot dust was later user-confirmed 1:1
> after the RNG-order fix. Current summary: `../freeroam-render-depth-parity.md`.
>
> **Historical status update (2026-06-03f): Phases 0–2 DONE; dust occlusion STILL OPEN → Phase 4 is the
