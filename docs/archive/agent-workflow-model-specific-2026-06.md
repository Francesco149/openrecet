# Historical agent workflow — model-specific split (2026-06)

> **ARCHIVED 2026-07-16.** This records the earlier vendor/model-specific
> orchestration convention and its useful calibration anecdotes. Current,
> model-agnostic workflow: `../AGENT-WORKFLOW.md`.
...
> Cross-cutting working conventions (knowledge-in-repo, confirmed-1:1 authority,
> verify-before-prune, run/commit rules) live in the auto-loaded `CLAUDE.md`. This doc is
> just the orchestration / model-split / sub-agent specifics.
