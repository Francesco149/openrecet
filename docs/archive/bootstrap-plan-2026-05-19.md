# OpenRecet — historical bootstrap plan (2026-05-19)

> **ARCHIVED 2026-07-16.** Preserved as the founding/bootstrap record. It contains
> superseded Wine/Xvfb, Trace Studio v1/v2, model-name, status, and fidelity guidance;
> do not use it operationally. Current charter: `../PLAN.md`. Current long-horizon
> tooling program: `../plans/parity-evidence-roadmap.md`.
