...
#define TESTS(X) \
    ...
    X(segtrace_wait_timeout_after_last_entry) \
    ...
    X(dialogue_run_se_fires_voice_bridge) \
    X(dialogue_run_se_null_bridge_is_noop) \
    ...
    X(scene1_tutloadpin_pins_bracket_length) \
    ...
    X(scene1_camera_follows_walking_player) \
    ...
    X(player_ctrl_walk_anim_starts_at_counter_zero) \
    ...
    X(companion_first_customer_freeroam) \
